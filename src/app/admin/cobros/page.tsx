  ...
  return (
    <>
      ...
      <div className="p-6 lg:p-8 max-w-5xl">
        {/* Encabezado */}
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-foreground">Cobros del mes</h2>
        ...
        {/* ── Resumen del mes ── */}
        <div className="flex items-center gap-4 p-5 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 mb-4">
        ...
        {/* ── Tabs ── */}
        <div className="flex items-center gap-1 mb-5 bg-gray-50 rounded-lg p-1 w-fit">
          {tabs.map((tab) => (
            <button
              key={tab.key}
          ...
          {filtered.map((puesto) => {
            ...
            return (
              <div
                key={puesto.id}
                className={clsx(
                  "rounded-2xl p-4 bg-white border flex items-center justify-between gap-4",
                  puesto.isVencido
                  ...
                  {isPaid ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="text-xs font-semibold bg-accent hover:bg-accent-hover text-white px-3 py-1.5 rounded-lg transition-colors"
                      >
                        Marcar pagado
                      </button>
                    </div>
